    ...
    return (
        <>
            ...
            <View style={styles.container}>
                ...
                <Text style={styles.text}>This is the default welcome screen for a {{ cookiecutter.project_name }} native app. It will only show once.</Text>
...
class CustomWebAppWrapper extends Component {
